...
const ViewAssignments = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 p-4 sm:p-6">
      <div className="w-full max-w-md sm:max-w-lg md:max-w-2xl bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-gray-200/30">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-navy-900 mb-2">Your Assignments</h2>
        ...
        {loading ? (
          ...
          <ul className="space-y-4">
            {assignments.map(assignment => (
              <li
                key={assignment._id}
                className="bg-white border border-gray-200 rounded-xl p-6 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200"
              >
                <h3 className="text-lg font-semibold text-coral-500 mb-2">{assignment.title}</h3>
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-coral-500 hover:text-coral-600 font-medium text-sm hover:underline transition-colors duration-200"
                >
        ...
        {message && (
          <p className="mt-6 text-center text-red-500 text-sm font-medium bg-red-50 border border-red-200 rounded-xl p-4">
            {message}
          </p>
        )}
