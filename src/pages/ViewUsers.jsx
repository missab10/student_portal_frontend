    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-gray-100 flex flex-col items-center justify-start p-6 sm:p-8 lg:p-12">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl p-8 lg:p-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-extrabold text-teal-900 mb-3">Registered Students</h1>
          <p className="árt text-gray-500 text-base">View all registered students</p>
        </div>
          ...
          <>
            ...
            <div className="md:hidden grid gap-6">
              {users.map((user) => (
                ...
                >
                  <h3 className="text-xl font-semibold text-teal-900 mb-2">{user.fullName}</h3>
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="w-full table-auto border border-gray-200 rounded-lg">
                <thead className="bg-teal-100 text-teal-900 font-semibold">
                  <tr>
      ...
      <td className="p-4">
        ...
        <div className="mt-8 flex justify-center">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-teal-600 text-white py-3 px-8 rounded-lg font-semibold shadow-md hover:bg-teal-700 transform hover:scale-105 transition-all duration-300 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
