...
//       localStorage.setItem('fullName', res.data.student.fullName); // ✅ Store full name
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://via.placeholder.com/1920x1080')" }}>
      <div className="min-h-screen bg-gradient-to-b from-slate-900/80 to-blue-900/80 flex items-center justify-center p-4 sm:p-6 lg:ml-64 transition-all duration-300">
        <div className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            />
            <p className="text-blue-200 text-sm mt-2 opacity-75">Sign in to your student account</p>
          </div>
...
<LoginButton
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl font-semibold text-lg shadow-lg hover:from-blue-500 hover:to-purple-500 transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900"
            >
              Login
            </LoginButton>
</div>
